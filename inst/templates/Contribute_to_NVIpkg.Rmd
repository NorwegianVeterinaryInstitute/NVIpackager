...
vignette: >
  ...
  %\VignetteIndexEntry{Contribute to _package_name_}
  %\VignetteEncoding
...
*   If you're adding a new function or new arguments to an existing function, you'll also need
    to document them. `NVIverse`-packages use [`roxygen2`](https://cran.r-project.org/package=roxygen2) for documentation. Make sure to re-run `devtools::document()` on the code before submitting. 
